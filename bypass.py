...
if __name__ == "__main__":
    ...
    if not proxies_list:
        print(f"{ts()} ⚠️  {Fore.YELLOW}No proxies found — add proxies to proxies.txt and try again.")
        exit(1)

    print(f"{ts()} {Fore.WHITE}Loaded {Fore.CYAN}{len(proxies_list)}{Fore.WHITE} proxies\n")
